      ...
      <div className="w-full max-w-md">
        <div className="bg-primaryWhite rounded-2xl shadow-xl p-8 border border-formColorLight/20">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-primaryBlack">Crear Cuenta</h1>
            <p className="text-primaryBlack/60 mt-2">Únete a la comunidad de mascotas</p>
          </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-primaryWhite text-primaryBlack/50">o regístrate con</span>
              </div>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-primaryBlack/60">
            ¿Ya tienes cuenta?{' '}
            <Link to="/login" className="text-redPink hover:text-formColorDark font-medium transition-colors">
              Inicia sesión
            </Link>
          </p>
        </div>
