...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { hasPet } = await login(email, password);
      ...
      <div className="w-full max-w-md">
        <div className="bg-primaryWhite rounded-2xl shadow-xl p-8 border border-formColorLight/20">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-primaryBlack">Iniciar Sesión</h1>
            <p className="text-primaryBlack/60 mt-2">Bienvenido de vuelta a Michigram</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-center mt-2">
              <Link
                to="/forgot-password"
                className="text-sm text-primaryBlack/50 hover:text-redPink transition-colors"
              >
          ...
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-formColorLight/30" />
              </div>
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-primaryWhite text-primaryBlack/50">o continúa con</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-formColorLight/30 rounded-lg hover:bg-primaryWhite transition-colors"
              >
          ...
          <p className="mt-6 text-center text-sm text-primaryBlack/60">
            ¿No tienes cuenta?{' '}
            <Link to="/register" className="text-redPink hover:text-formColorDark font-medium transition-colors">
              Regístrate
            </Link>
          </p>
        </div>
