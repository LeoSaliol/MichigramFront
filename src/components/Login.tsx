                ...
                <div className="bg-primaryWhite rounded-2xl shadow-xl p-8 border border-formColorLight/20">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-primaryBlack/60 mt-2">
                            Bienvenido de vuelta a Michigram
                        </p>
                    </div>
                    ...
                    >
                        <div>
                            <label
                                htmlFor="email"
                                className="block text-sm font-medium text-primaryBlack mb-1"
                            >
                                Correo electrónico
                            </label>
                            <input
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-primaryWhite text-primaryBlack/50">
                                    o continúa con
                                </span>
                            </div>
                        </div>
                    ...
                    <p className="mt-6 text-center text-sm text-primaryBlack/60">
                        ...
                        <Link
                            to="/register"
                            className="text-redPink hover:text-formColorDark font-medium transition-colors"
                        >
                            Regístrate
                        </Link>
                    </p>
